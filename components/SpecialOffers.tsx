  ...
  return (
    <section className="px-6">
        ...
        <div className="p-8">
          ...
          <div className="flex items-center justify-between pt-6 border-t border-gray-50">
            ...
            <button
              ...
              className="w-10 h-10 border border-gray-200 flex items-center justify-center hover:bg-black hover:text-white transition-all"
            >
      ...
      <div className="mt-12 flex justify-between items-center text-[10px] font-bold tracking-[0.2em] uppercase">
        <button onClick={() => navigate('/package')} className="text-black border-b border-black pb-0.5">All Packages</button>
